...
function StepDetails({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Garment selector */}
      <FormField label="Garment" required hint="Select the style this campaign is for. Garments are created in your PLM dashboard.">
        {garmentsLoading ? (
          ...
          <div className="p-4 bg-amber-50 border border-amber-200 rounded-[var(--radius-md)] text-sm">
            ...
            <p className="text-amber-600">
              Create a garment in your{" "}
              <Link href="/plm" className="underline hover:no-underline">PLM dashboard</Link>{" "}
