...
export default function BrandLayout({ children }: { children: React.ReactNode }) {
  ...
  const navGroups = [
    ...
    },
    {
      label: "Production",
      items: [
        { href: "/brand/garments", label: "Garment Library", icon: "👗" },
        { href: "/brand/plm", label: "PLM Pipeline", icon: "📋" },
      ],
    },
    {
      label: "Campaigns",
      items: [
        { href: "/brand/campaigns", label: "Back It Campaigns", icon: "🚀" },
      ],
    },
    {
      label: "Manufacturers",
      items: [
        { href: "/brand/manufacturers", label: "Find Manufacturers", icon: "🔍" },
        { href: "/brand/manufacturers/connections", label: "My Connections", icon: "🤝" },
      ],
    },
    {
      label: "Settings",
      items: [
        { href: "/brand/size-charts", label: "Size Charts", icon: "📐" },
      ],
    },
  ];
